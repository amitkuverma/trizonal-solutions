        ...
        <div className="container py-4 py-md-5">
          <div class="row">
            <div className="col-12 col-md-8">
              <article id="post-2455" class="post post-2455 type-post status-publish format-standard hentry category-healthcare">
                <div class="post_headings">
                  <h2 class="post_title"><a className="text-dark text-decoration-none fnt-fly fnt-24 fnt-md-32 fw-900 text-uppercase" href="#">Healthcare Trends in 2023 and Beyond</a></h2>          </div>
                <div class="post_figure_and_info">
                  <div class="post_sub"><span class="post_info post_date"><i class="fa fa-calendar"></i> August 14, 2023</span><a href="#" title="deecantrell"><span class="post_info post_author">deecantrell</span></a><a href="#" title="View all posts in category: Healthcare"><span class="post_info post_categories">Healthcare</span></a></div>              </div>
                ...
                <p>
                  <a href="#" class="btn btn-primary update-btn text-uppercase py-2">Read More</a>
                </p>
              </article>

            </div>
            <div className="col-12 col-md-4">
              <aside id="recent-posts-2" class="left-side">
