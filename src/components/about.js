                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-6">
                        <div className="wpb_wrapper">
                            ...
                            <p><strong>In brief,&nbsp;<span className="cstm-text-blue">HealthAll Consulting</span>&nbsp;is dedicated to helping healthcare organizations:</strong></p>
                            <ul>
