                ...
                <div className="container pt-4 pt-md-5">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6">
                            ...
                            <p className="lh-225 fnt-15">The healthcare professionals at Trizonal Solution represent the best talent in the industry. Our Associates include professionals who have held “C” level positions, Program Directors and Sr. Project Manager titles, overseeing large complex system integration, conversion, and implementation projects. Many others are specialists and experts in specific areas of health plans and hospital business operations such as EHR/EMR, Claims, Configuration, Billing, Membership, Medical Management, Reporting, Testing, HIE, Revenue Cycle Management, Meaningful Use, Medicaid, Medicare, HIPAA, ICD-10, 5010, and more.</p>
                    ...
                    <div className="">
                        <p className="lh-225 fnt-15"><span className="cstm-text-blue">Trizonal Solution</span>&nbsp;focuses on delivering expert consulting services that assist organizations to optimize their Electronic Health Record (EHR) investments through processes that will maximize integration, workflow, and outcomes.</p>
                        <p className="lh-225 fnt-15">Our industry is actively embracing as well as encouraging all providers and payers to implement telehealth solutions. At Trizonal Solution we are experienced and prepared to help your organization implement, rollout, and support your telehealth objectives.</p>
                        <p className="lh-225 fnt-15">Overall,&nbsp;Trizonal Solution&nbsp;clients include; Hospitals, IDN’s, HMO’s, PPO’s, TPA’s, Blue Cross and Blue Shield plans, software vendors, and global consulting firm business partners throughout the United States, Latin America, and the Caribbean.</p>
                    </div>
                </div>
                <div id="payers_service" className="container" >
                    <hr />
                    <h2 className="fw-900 fnt-22 fnt-md-24 fnt-fly text-uppercase">PAYERS</h2>
                    <p><b><span className="cstm-text-blue-unitalic">At&nbsp;<span className="cstm-text-blue">Trizonal Solution</span>, our payer services focus on your core claim and medical management systems.</span></b>&nbsp;We offer expert level knowledge about these core systems to help your organization achieve its objectives and reduce cost. We can help your organization successfully implement and utilize technologies that improve operational efficiency and solve complex member care management issues. View each category below to find out more information.</p>
