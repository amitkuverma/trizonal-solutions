        ...
        <Layout active={"clients"}>
            ...
            <div className="container pb-4">
                <div className="client_wrapper">
                    ...
                    <p className="py-3  pb-md-4">At Trizonal Solution, we provide “<strong>QUALITY</strong>” consulting that will meet the specific needs of your business. We are committed to providing our clients with the “<strong>BEST VALUE</strong>” for their investment. Trizonal Solution strives to create a lasting partnership with our clients based on “<strong>TRUST.</strong>”</p>
                </div>
                <div className="row">
